...
boolean[] usedOptionLevel1 = { false, false, false, false, false, false, false, false, false };
int[] answerLevel1 = {0, 1, 2, 3, 4, 5, 6, 7, 8}; 
//fase2
String[] optionsLevel2 = { 
    "idade =", "15","altura = ", "1.70", 
    "nome =", "Lucas", "tem_cachorro =", "True",
    "print(idade, altura, nome, tem_cachorro)"};
boolean[] usedOptionLevel2 = { false, false, false, false, false, false, false, false, false };
int[] answerLevel2 = {0, 1, 2, 3, 4, 5, 6, 7, 8};
//fase3
...
String[] optionsLevel10 = { 
    ...
    "print(comidas[1])",
    "print(comidas[2])"};
boolean[] usedOptionLevel10 = { false, false, false, false, false, false };
int[] answerLevel10 = {0, 1, 2, 3, 4, 5};
//fase11
String[] optionsLevel11= { 
    "amigos = [Ana", "Pedro", "João]",
    "for nome in amigos:",
    "  print(Olá,", "nome", "!)"};
boolean[] usedOptionLevel11 = { false, false, false, false, false, false, false };
int[] answerLevel11 = {0, 1, 2, 3, 4, 5, 6};
//fase12
String[] optionsLevel12 = { 
    "cores = [azul", "verde", "vermelho", "amarelo]",
    "print(Número de cores na lista:", "len(cores))"};
boolean[] usedOptionLevel12 = { false, false, false, false, false, false };
int[] answerLevel12 = {0, 1, 2, 3, 4, 5};
//fase13
